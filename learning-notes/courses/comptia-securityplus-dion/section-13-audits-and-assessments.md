...
- [Flashcards created for audit types, pen test phases, and reporting requirements](https://jeremyrayjewell-flashcards.netlify.app/security-plus-dion.html#deck=13)
