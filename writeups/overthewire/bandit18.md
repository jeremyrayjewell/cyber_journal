...
Here we must bypass an interactive shell trap. We are given the password
...
# append to the history file, don't overwrite it                                                                     21:18:04 [70/462]
shopt -s histappend                                                                                                                   
...
if [ -n "$force_color_prompt" ]; then                              
    if [ -x /usr/bin/tput ] && tput setaf 1 >&/dev/null; then   
        # We have color support; assume it's compliant with Ecma-48                                                  21:18:04 [35/462]
...
if [ "$color_prompt" = yes ]; then                                 
    ...
    PS1='${debian_chroot:+($debian_chroot)}\u@$GAMEHOSTNAME:\w\$ '                                                                    fi                            
